...
if (window.DeviceOrientationEvent && 'ontouchstart' in window) {
    ...
    function handleOrientation(event) {
        ...
        let _depth1 = `50% 50%`;
        let _depth2 = `${50 - ((yTilt + 10) / .10000000000)}% ${50 - ((xTilt + 10) / .10000000000)}%`;
        let _depth3 = `${50 - ((yTilt + 10) / .10000000000)}% ${50 - ((xTilt + 10) / .10000000000)}%`;
        let _depth4 = `${50 - ((yTilt + 10) / .10000000000)}% ${50 - ((xTilt + 10) / .10000000000)}%`;
        let _depth5 = `${50 - ((yTilt + 10) / .10000000000)}% ${50 - ((xTilt + 10) / .10000000000)}%`;
